...
<section class="bg-white dark:bg-gray-900 min-h-[80vh]">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-12 lg:px-6">
        <div class="max-w-screen-sm text-left lg:mb-8 mb-8">
            <h2 class="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Liam's Posts</h2>
            <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">Mostly my thoughts about Audiobooks.</p>
        </div>
            ...
            <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 ">
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><a href="#">{post.meta.title}</a></h2>
                        <p class="mb-5 font-light text-gray-500 dark:text-gray-400">{post.meta.description}</p>
                        <div class="flex justify-between items-center">
                            <a href="/{post.path}" class="inline-flex items-center font-medium text-primary-600 dark:text-primary-500 hover:underline">
                                Read more
