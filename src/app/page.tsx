          ...
          <div className="space-y-4 py-1 text-base leading-7 sm:landscape:space-y-2 sm:landscape:leading-3 sm:mx-4">
            <article className="prose lg:prose-xl text-white sm:landscape:prose-md">
              <div className="text-center items-center md:m-4">
                <h1 className="mt-2 text-6xl font-bold tracking-tight text-black dark:text-white text-left px-7 mb-0">Liam<br/>Griffiths<br/><div className="font-light text-gray-700 dark:text-black mt-2" ><span className="underline">Software<br/>Engineer</span><span className="font-bold ml-1 blinking-cursor">|</span></div></h1>
